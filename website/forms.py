...
class InscriptionFormEn(forms.Form):
    name = forms.CharField(required=True, max_length=150, widget=forms.TextInput(attrs={'placeholder': 'Full name', 'class': 'form-control', 'id': 'formGroupExampleInput'}))
    ...
    adress = forms.CharField(required=True, max_length=200, widget=forms.TextInput(attrs={'placeholder': 'Adress', 'class': 'form-control', 'id': 'formGroupExampleInput'}))
    adress_num = forms.IntegerField(required=True, widget=forms.NumberInput(attrs={'placeholder':'Number', 'class': 'form-control', 'id': 'formGroupExampleInput'}))
    ...
    initiations = forms.CharField(required=True,max_length=2000, widget=forms.Textarea(attrs={'placeholder': 'Ex: Guru Rinpoche', 'class': 'form-control form_text_area', 'id': 'formGroupExampleInput'}))
    initiations_lama = forms.CharField(required=True,max_length=2000, widget=forms.Textarea(attrs={'placeholder': 'Ex: S. E. Dzongsar Khyentse Rinpoche', 'class': 'form-control form_text_area', 'id': 'formGroupExampleInput'}))
    monastic_ordenation = forms.ChoiceField(required=True, widget=forms.RadioSelect(attrs={'value':'1','type':'radio', 'class':'form-check inline'}), choices=(
        ('Sim','Yes'),
        ('Não','No'),
